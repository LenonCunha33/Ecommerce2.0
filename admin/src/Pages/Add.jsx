...
const Add = ({ token }) => {
  ...
  return (
    <motion.form
      ...
      className="flex flex-col w-full max-w-3xl mx-auto px-4 py-6 sm:px-6 md:px-10 gap-6 bg-white rounded-xl shadow-lg border border-gray-100"
    ...
    >
      ...
      {/* Upload de Imagem */}
      <div>
        <p className="mb-3 font-medium text-gray-700">Enviar Imagens</p>
          ...
          {[image1, image2, image3, image4].map((img, index) => {
            ...
            return (
              <motion.label
                ...
                key={index}
                className="w-full h-24 sm:h-28 border rounded-md overflow-hidden cursor-pointer bg-gray-50 hover:shadow-md transition-all duration-300 flex items-center justify-center"
      ...
      <div>
        ...
        <input
          ...
          required
          className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          required
          className="w-full px-4 py-2 h-28 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 resize-none transition-all"
        />
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          ...
          <select
            ...
            value={category}
            className="w-full px-4 py-2 border border-gray-300 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
          >
      ...
      <motion.button
        type="submit"
        className="mt-4 bg-gray-800 text-white font-semibold px-6 py-2 rounded-full hover:bg-gray-700 transition-all shadow-sm cursor-pointer"
